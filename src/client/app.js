...
$('#div_color_legend').height($(window).height()*1);
...
function update_map(){
	...
	markersCluster.on('clusterclick', function (a) {
		...
		var gwidth_selectedcluster = $("#graphe2").width() - 5;
		var gheight_selectedcluster = $("#graphe2").height() -5;
...
function create_histogram(date_max,date_min,data_events,nb_classes,color_classes){
	...
	var gwidth = $("#graphe1").width() - 5;
	var gheight = $("#graphe1").height() -5;
