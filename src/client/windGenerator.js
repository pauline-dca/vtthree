...
var geometry = {
  ...
  coordinates: [
    [
      proj4(proj3857, proj4326, [258500, 6249000]),
      proj4(proj3857, proj4326, [258500, 6248000]),
      proj4(proj3857, proj4326, [259500, 6248000]),
      proj4(proj3857, proj4326, [259500, 6249000]),
    ]
  ]
};
...
let grid = turf.squareGrid(turf.bbox(feature), 0.02, options);
